...
Route::get('/stripe/{total_price}',[\App\Http\Controllers\HomeController::class,'stripe'])->name('stripe');
Route::post('/stripe/{total_price}',[\App\Http\Controllers\HomeController::class,'stripePost'])->name('stripe.post');